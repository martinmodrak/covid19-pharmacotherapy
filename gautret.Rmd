...
data_for_model <- create_data_for_model(gautret %>% filter(Source == "Excluded") %>% mutate(NumericID = 1:n()), prior_hmm, use_time_effect = FALSE, max_observation_shift = 2, N_time = 10)
